 ...
 * Use the [EditarComentarioFragment.newInstance] factory method to
...
class EditarComentarioFragment : Fragment() {
	...
	companion object {
		 ...
		 * @return A new instance of fragment EditarComentarioFragment.
		 */
		// TODO: Rename and change types and number of parameters
		@JvmStatic
		fun newInstance(param1: String, param2: String) =
			EditarComentarioFragment().apply {
